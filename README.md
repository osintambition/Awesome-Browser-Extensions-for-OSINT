...
|[AWAGAM TLD, Domain, and URL Blocker](https://chromewebstore.google.com/detail/ia-defensa-awagam-tld-dom/efnpgpiffjglnijemnmdkemiliiialbm) || Blocklist-based and configurable extension to prevent navigating to and loading from configured TLDs, domains, and URLs.|
...
|[New Tab Traffic Randomizer](https://chromewebstore.google.com/detail/ia-defensa-new-tab-traffi/albacpkkpmjpmhlgmkfmnedcbjflibpd)|| Opens new tabs with random (and configurable) web pages, for improved traffic privacy.|
|[Searcher](https://chromewebstore.google.com/detail/ia-defensa-searcher/lbeplcjbfdepkohcmmionehhodkipkhd)|| Triggers realistic searches on websites, to obscure search behavior.|
